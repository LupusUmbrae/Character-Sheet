...
import static org.moss.charactersheet.services.character.info.CombatService.BASE_ATTACK;
...
import org.moss.charactersheet.services.character.info.CombatService;
...
public class CombatOptionsGui implements GenerateGui<CombatStats> {
	...
	public CombatStats save() {
        return combatService.save(combatOptions);
	}
}
